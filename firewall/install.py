...
if __name__ == "__main__":
    ...
    if subprocess.call("mkdir " + config.dir, shell=True) != 0:
        print "Sorry, project is already exists, please delete it and try again." 
        sys.exit()
        
    if subprocess.call("iptables-save > " + config.backup_path, shell=True) != 0:
        print "Somthing wrong with iptables-save. Please make sure you have install 'iptables-save' and try again."
        sys.exit()
